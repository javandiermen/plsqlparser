...
//JvD
create_procedure_body
    : CREATE (OR REPLACE)? (create_procedure_editionable)? PROCEDURE procedure_name ('(' parameter (',' parameter)* ')')?
      invoker_rights_clause? (IS | AS)
      (DECLARE? seq_of_declare_specs? body | call_spec | EXTERNAL) ';'
    ;

//JvD
create_procedure_editionable
...
//JvD:added INQUIRY_DIRECTIVE
general_element_part
    : (inquiry_directive |(INTRODUCER char_set_name))? id_expression ('.' id_expression)* ('@' link_name)? function_argument?
    ;
